...
tfidf = pickle.load(open(r"C:\Users\ayati\OneDrive\Documents\PYTHON (AIML)\SMS\sms+spam+collection (unzipped file)\vectorizer.pkl", 'rb'))
model = pickle.load(open(r"C:\Users\ayati\OneDrive\Documents\PYTHON (AIML)\SMS\sms+spam+collection (unzipped file)\model.pkl", 'rb'))
